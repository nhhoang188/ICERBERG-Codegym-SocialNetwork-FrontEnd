...
@Component({
  selector: 'app-time-line-post',
  templateUrl: './time-line-post.component.html',
  styleUrls: ['./time-line-post.component.css']
})
export class TimeLinePostComponent implements OnInit {
  ...
  getPostInTimeLine() {
    this.postSv.getAllPostIntimeLine(this.userId).subscribe(value => {
      this.listPost = value;
    });
  }
